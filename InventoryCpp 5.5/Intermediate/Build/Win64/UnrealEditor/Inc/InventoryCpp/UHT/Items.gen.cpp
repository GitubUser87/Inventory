...
// Begin ScriptStruct FItemStruct2
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_ItemStruct2;
class UScriptStruct* FItemStruct2::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_ItemStruct2.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_ItemStruct2.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemStruct2, (UObject*)Z_Construct_UPackage__Script_InventoryCpp(), TEXT("ItemStruct2"));
	}
	return Z_Registration_Info_UScriptStruct_ItemStruct2.OuterSingleton;
}
template<> INVENTORYCPP_API UScriptStruct* StaticStruct<FItemStruct2>()
{
	return FItemStruct2::StaticStruct();
}
struct Z_Construct_UScriptStruct_FItemStruct2_Statics
{
#if WITH_METADATA
	...
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FItemStruct2>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_name = { "name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemStruct2, name), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_name_MetaData), NewProp_name_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_value = { "value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemStruct2, value), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_value_MetaData), NewProp_value_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weight = { "weight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemStruct2, weight), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_weight_MetaData), NewProp_weight_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_HealthRestore = { "HealthRestore", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemStruct2, HealthRestore), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HealthRestore_MetaData), NewProp_HealthRestore_MetaData) };
void Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_consumable_SetBit(void* Obj)
{
	((FItemStruct2*)Obj)->consumable = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_consumable = { "consumable", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FItemStruct2), &Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_consumable_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_consumable_MetaData), NewProp_consumable_MetaData) };
void Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weapon_SetBit(void* Obj)
{
	((FItemStruct2*)Obj)->weapon = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weapon = { "weapon", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FItemStruct2), &Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weapon_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_weapon_MetaData), NewProp_weapon_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp__mymesh = { "_mymesh", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemStruct2, _mymesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__mymesh_MetaData), NewProp__mymesh_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FItemStruct2_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_name,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_value,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weight,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_HealthRestore,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_consumable,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp_weapon,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemStruct2_Statics::NewProp__mymesh,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemStruct2_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FItemStruct2_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_InventoryCpp,
	nullptr,
	&NewStructOps,
	"ItemStruct2",
	Z_Construct_UScriptStruct_FItemStruct2_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemStruct2_Statics::PropPointers),
	sizeof(FItemStruct2),
	alignof(FItemStruct2),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemStruct2_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FItemStruct2_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FItemStruct2()
{
	if (!Z_Registration_Info_UScriptStruct_ItemStruct2.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_ItemStruct2.InnerSingleton, Z_Construct_UScriptStruct_FItemStruct2_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_ItemStruct2.InnerSingleton;
}
// End ScriptStruct FItemStruct2
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FItemStruct2::StaticStruct, Z_Construct_UScriptStruct_FItemStruct2_Statics::NewStructOps, TEXT("ItemStruct2"), &Z_Registration_Info_UScriptStruct_ItemStruct2, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FItemStruct2), 664639469U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AItems, AItems::StaticClass, TEXT("AItems"), &Z_Registration_Info_UClass_AItems, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AItems), 3462468432U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_3556237986(TEXT("/Script/InventoryCpp"),
	Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_D3303414_Source_repos_Inventory_InventoryCpp_5_5_Source_InventoryCpp_Public_Items_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
